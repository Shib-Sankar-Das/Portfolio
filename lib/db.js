...
-- --------------------------- technology icons -----------------------------
-- One row per icon in the technology set. Written by portfolio_admin; read
-- here. These are vendor logos, not the owner's documents, so they sit on
-- Cloudinary under public delivery and icon_url is fetched directly.
--
-- The same text at three lengths: short_description is one line,
-- detailed_description two or three, and long_description is JSON —
-- { "intro": "…", "points": ["…", "…", "…"] }.
...
CREATE INDEX IF NOT EXISTS idx_tech_icons_label ON tech_icons(label);
